...
function preload() {
    ...
    /*
    bqp_imgs['bqp_TH'] = loadImage('assets/bqp_TH.png');
    bqp_imgs['bqp_SW'] = loadImage('assets/bqp_SW.png');
    bqp_imgs['bqp_BAN'] = loadImage('assets/bqp_BAN.png');
    bqp_imgs['bqp_THU'] = loadImage('assets/bqp_THU.png');
    bqp_imgs['bqp_CAMO'] = loadImage('assets/bqp_CAMO.png');
    bqp_imgs['bqp_BOT'] = loadImage('assets/bqp_BOT.png');
    bqp_imgs['bqp_KA'] = loadImage('assets/bqp_KA.png');
    bqp_imgs['bqp_SM'] = loadImage('assets/bqp_SM.png');
    bqp_imgs['bqp_WH'] = loadImage('assets/bqp_WH.png');
    bqp_imgs['bqp_CH'] = loadImage('assets/bqp_CH.png');
    bqp_imgs['bqp_PA'] = loadImage('assets/bqp_PA.png');
    bqp_imgs['bqp_BER'] = loadImage('assets/bqp_BER.png');
    bqp_imgs['bqp_BANG'] = loadImage('assets/bqp_BANG.png');
    bqp_imgs['bqp_BEAD'] = loadImage('assets/bqp_BEAD.png');
    bqp_imgs['bqp_PI'] = loadImage('assets/bqp_PI.png');
    bqp_imgs['bqp_LE'] = loadImage('assets/bqp_LE.png');
    bqp_imgs['bqp_DEMO'] = loadImage('assets/bqp_DEMO.png');
    bqp_imgs['bqp_CAMP'] = loadImage('assets/bqp_CAMP.png');
    bqp_imgs['bqp_AU'] = loadImage('assets/bqp_AU.png');
    bqp_imgs['bqp_RO'] = loadImage('assets/bqp_RO.png');
    bqp_imgs['bqp_PIN'] = loadImage('assets/bqp_PIN.png');
    bqp_imgs['bqp_CAN'] = loadImage('assets/bqp_CAN.png');
    bqp_imgs['bqp_EL'] = loadImage('assets/bqp_EL.png');
    bqp_imgs['bqp_SI'] = loadImage('assets/bqp_SI.png');
    bqp_imgs['bqp_WA'] = loadImage('assets/bqp_WA.png');
    bqp_imgs['bqp_PE'] = loadImage('assets/bqp_PE.png');
    bqp_imgs['bqp_BEE'] = loadImage('assets/bqp_BEE.png');
    bqp_imgs['bqp_PINE'] = loadImage('assets/bqp_PINE.png');
    bqp_imgs['bqp_ICI'] = loadImage('assets/bqp_ICI.png');
    bqp_imgs['bqp_BEES'] = loadImage('assets/bqp_BEES.png');
    bqp_imgs['bqp_BUBB'] = loadImage('assets/bqp_BUBB.png');
    bqp_imgs['bqp_SN'] = loadImage('assets/bqp_SN.png');
    bqp_imgs['bqp_SNO'] = loadImage('assets/bqp_SNO.png');
    bqp_imgs['bqp_RE'] = loadImage('assets/bqp_RE.png');
    bqp_imgs['bqp_TO'] = loadImage('assets/bqp_TO.png');
    bqp_imgs['bqp_PAP'] = loadImage('assets/bqp_PAP.png');
    bqp_imgs['bqp_TOY'] = loadImage('assets/bqp_TOY.png');
    bqp_imgs['bqp_LU'] = loadImage('assets/bqp_LU.png');
    bqp_imgs['bqp_PO'] = loadImage('assets/bqp_PO.png');
    bqp_imgs['bqp_ELE'] = loadImage('assets/bqp_ELE.png');
    bqp_imgs['bqp_FES'] = loadImage('assets/bqp_FES.png');
    */
}
